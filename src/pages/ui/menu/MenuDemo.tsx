...
const MenuDemo = ({ children }: any) => {
    ...
    const wizardItems = [
        { label: 'Personal', command: () => router('/uikit/menu') },
        { label: 'Seat', command: () => router('/uikit/menu/seat') },
        { label: 'Payment', command: () => router('/uikit/menu/payment') },
        {
            label: 'Confirmation',
            command: () => router('/uikit/menu/confirmation')
        }
    ];
